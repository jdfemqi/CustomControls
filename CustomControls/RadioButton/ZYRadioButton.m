...
-(void)defaultInit{
    ...
    //正常状态下的按钮背景图片(从bundle中获取图片资源)
    [_button setImage:[UIImage imageWithContentsOfFile: [BundleTools getBundlePath: @"RadioButton-Unselected"]] forState:UIControlStateNormal];
    
    //选择状态下的按钮背景图片
    [_button setImage:[UIImage imageWithContentsOfFile: [BundleTools getBundlePath: @"RadioButton-Selected"]] forState:UIControlStateSelected];
...
-(void)setFrame:(CGRect)frame
{
    ...
    CGRect rcLab = CGRectMake(kRadioButtonWidth + 3, 0, self.frame.size.width - (kRadioButtonWidth + 3), kRadioButtonHeight);
